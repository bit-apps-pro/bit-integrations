...
import { handleInput } from './MainWPCommonFunc'

export default function MainWPAuthorization({
  formID,
  mainWPConf,
  setMainWPConf,
  step,
    ...
    <div
      ...
      {showAuthMsg && isAuthorized && !isLoading && (
        <div className="flx mt-5" style={{ width: 900 }}>
          ...
          <div className="mt-2">{__('MainWP Dashboard is activated', 'bit-integrations')}</div>
        </div>
      )}
      ...
      <button
        ...
        {isAuthorized
          ...
          : __('Connect to MainWP Dashboard', 'bit-integrations')}
