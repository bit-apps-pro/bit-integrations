      ...
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          <select
            ...
            onChange={ev => handleFieldMapping(ev, i, quizMakerConf, setQuizMakerConf)}>
          ...
          <select
            ...
            name="quizMakerField"
            value={i < requiredFlds ? requiredFlds[i].label || '' : field.quizMakerField || ''}
            onChange={ev => handleFieldMapping(ev, i, quizMakerConf, setQuizMakerConf)}>
            <option value="">{__('Select Field', 'bit-integrations')}</option>
        ...
        {i >= requiredFlds.length && (
          <>
            <button
              onClick={() => addFieldMap(i, quizMakerConf, setQuizMakerConf)}
