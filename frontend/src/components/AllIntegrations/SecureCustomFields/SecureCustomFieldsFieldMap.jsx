...
export default function SecureCustomFieldsFieldMap({
  i,
  formFields,
  field,
  ...
  const requiredFlds =
    secureCustomFieldsConf?.secureCustomFieldsFields?.filter(fld => fld.required === true) || []
  const nonRequiredFlds =
    secureCustomFieldsConf?.secureCustomFieldsFields?.filter(fld => fld.required === false) || []
      ...
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          ...
          <select
            ...
            name="secureCustomFieldsField"
            value={field.secureCustomFieldsField || ''}
            onChange={ev =>
              handleFieldMapping(ev, i, secureCustomFieldsConf, setSecureCustomFieldsConf)
            }>
            <option value="">{__('Select Field', 'bit-integrations')}</option>
