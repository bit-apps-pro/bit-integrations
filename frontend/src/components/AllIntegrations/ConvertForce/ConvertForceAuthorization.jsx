...
export default function ConvertForceAuthorization({
  ...
  return (
    <div
      ...
      <TutorialLink linkKey="convertForce" />
      ...
      {isLoading === 'auth' && (
        <div className="flx mt-5">
          ...
          {__('Checking if ConvertForce Popup Builder is authorized!!!', 'bit-integrations')}
        </div>
      )}
      ...
      {showAuthMsg && !isAuthorized && !isLoading && (
        <div className="flx mt-5" style={{ width: 900, justifyContent: 'center' }}>
          <div className="txt-center">
            ...
            <div className="mt-2">
              {__('ConvertForce Popup Builder is not activated or not installed', 'bit-integrations')}
            </div>
          </div>
        </div>
      )}
      ...
      {showAuthMsg && isAuthorized && !isLoading && (
        <div className="flx mt-5" style={{ width: 900 }}>
          ...
          <div className="mt-2">{__('ConvertForce Popup Builder is activated', 'bit-integrations')}</div>
        </div>
      )}
      ...
      <button
        ...
        {isAuthorized
          ...
          : __('Connect to ConvertForce Popup Builder', 'bit-integrations')}
