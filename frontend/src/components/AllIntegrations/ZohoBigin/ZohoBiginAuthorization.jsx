...
export default function ZohoBiginAuthorization({
  ...
  const loadModules = useCallback(
    async connectionId => {
      const nextConf = connectionId ? { ...biginConf, connection_id: connectionId } : biginConf
      refreshModules(formID, nextConf, setBiginConf, setIsLoading, setSnackbar)
    },
    [biginConf, formID, setBiginConf, setIsLoading, setSnackbar]
  )
  ...
  return (
    <Authorization
      ...
      isInfo={isInfo}
      tutorialTitle="Zoho Bigin"
      tutorialLinks={tutorialLinks?.zohoBigin || {}}
      authDetails={{
