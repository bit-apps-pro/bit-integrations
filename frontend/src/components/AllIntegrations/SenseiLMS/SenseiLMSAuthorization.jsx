...
export default function SenseiLMSAuthorization({
  ...
  const handleInput = e => {
    const newConf = { ...senseiLMSConf }
    newConf[e.target.name] = e.target.value
    setSenseiLMSConf(newConf)
  }
  ...
  return (
    <div
      ...
      <TutorialLink linkKey="senseiLMS" />
      ...
      {showAuthMsg && isAuthorized && !isLoading && (
        <div className="flx mt-5" style={{ width: 900 }}>
          ...
          <div className="mt-2">{__('Sensei LMS is activated', 'bit-integrations')}</div>
        </div>
      )}
      ...
      <button
        ...
        {isAuthorized
          ...
          : __('Connect to Sensei LMS', 'bit-integrations')}
