      ...
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          <select
            ...
            onChange={ev => handleFieldMapping(ev, i, senderConf, setSenderConf)}>
          ...
          {field.formField === 'custom' && (
            <TagifyInput
              onChange={e => handleCustomValue(e, i, senderConf, setSenderConf)}
          ...
          <select
            ...
            name="senderField"
            value={i < requiredFlds.length ? requiredFlds[i].key || '' : field.senderField || ''}
            onChange={ev => handleFieldMapping(ev, i, senderConf, setSenderConf)}>
            <option value="">{__('Select Field', 'bit-integrations')}</option>
        ...
        {i >= requiredFlds.length && (
          <>
            <button
              onClick={() => addFieldMap(i, senderConf, setSenderConf)}
              className="icn-btn sh-sm ml-2 mr-1"
              type="button">
              +
            </button>
            <button
              onClick={() => delFieldMap(i, senderConf, setSenderConf)}
