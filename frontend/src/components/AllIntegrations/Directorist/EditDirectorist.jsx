...
export default function EditDirectorist({ allIntegURL }) {
  ...
  const [directoristConf, setDirectoristConf] = useRecoilState($actionConf)
    ...
    <div style={{ width: 900 }}>
      ...
      <div className="flx mt-3">
        ...
        <input
          ...
          onChange={e => handleInput(e, directoristConf, setDirectoristConf)}
          name="name"
          value={directoristConf.name}
          type="text"
