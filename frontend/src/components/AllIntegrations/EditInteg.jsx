...
const EditDirectorist = lazy(() => import('./Directorist/EditDirectorist'))
...
const EditModernCart = lazy(() => import('./ModernCart/EditModernCart'))
...
const IntegType = memo(({ allIntegURL, flow }) => {
  switch (flow?.flow_details?.type) {
    ...
    case 'Fabman':
      return <EditFabman allIntegURL={allIntegURL} />
    case 'PCloud':
    ...
    case 'Directorist':
      return <EditDirectorist allIntegURL={allIntegURL} />
    case 'NextCrm':
    ...
    case 'ModernCart':
      return <EditModernCart allIntegURL={allIntegURL} />
    case 'PowerCoupons':
