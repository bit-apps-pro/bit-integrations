...
export default function FluentPlayerAuthorization({
  ...
  const handleInput = e => {
    const newConf = { ...fluentPlayerConf }
    newConf[e.target.name] = e.target.value
    setFluentPlayerConf(newConf)
  }
  ...
  return (
    <div
      ...
      <TutorialLink linkKey="fluentPlayer" />
      ...
      {isLoading === 'auth' && (
        <div className="flx mt-5">
          ...
          {__('Checking if FluentPlayer is authorized!!!', 'bit-integrations')}
        </div>
      )}
      ...
      {showAuthMsg && isAuthorized && !isLoading && (
        <div className="flx mt-5" style={{ width: 900 }}>
          ...
          <div className="mt-2">{__('FluentPlayer is activated', 'bit-integrations')}</div>
        </div>
      )}
        ...
        <>
          <button
            ...
            {isAuthorized
              ...
              : __('Connect to FluentPlayer', 'bit-integrations')}
