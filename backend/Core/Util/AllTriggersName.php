...
final class AllTriggersName
{
    public static function allTriggersName()
    {
        return [
            ...
            'IvyForms'                       => ['name' => 'IvyForms',  'isPro' => true, 'is_active' => false],
            ...
            'RoxAppointmentBooking'          => ['name' => 'Rox Appointment Booking',  'isPro' => true, 'is_active' => false],
            ...
            'WebbaBooking'                   => ['name' => 'Webba Booking Calendar',  'isPro' => true, 'is_active' => false],
